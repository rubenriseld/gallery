...
{
    public static async Task<IResult> HttpGetAsync<TEntity, TDto>(this IGalleryService db)
    ...
    public static async Task<IResult> HttpPostAsync<TEntity, TDto>(this IGalleryService db, TDto dto)
        where TEntity : class, IEntity
        where TDto : class
    {
        try
    ...
    public static async Task<IResult> HttpPutAsync<TEntity, TDto>(this IGalleryService db, int id, TDto dto)
        where TEntity : class, IEntity
        where TDto : class
    {
        try
    ...
    public static async Task<IResult> HttpDeleteAsync<TEntity>(this IGalleryService db, int id)
        where TEntity : class, IEntity
    {
        try
        {
    ...
    //public static async Task<IResult> HttpDeleteAsync<TReferenceEntity, TDto>(this IGalleryService db, TDto dto)
    ...
    //public static async Task<IResult> HttpAddAsync<TEntity, TDto>(this IGalleryService db, TDto dto)
